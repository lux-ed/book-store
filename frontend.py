...
def search_command():
    list1.delete(0, END)
    # because the title_text widget is an object, you have to get the data that the user inputs. 
...
def update_command():
    ...
    # the first arg is for the id and we want to keep it
...
#function that creates this spatial object
...
#connecting the list with the scrollbar
